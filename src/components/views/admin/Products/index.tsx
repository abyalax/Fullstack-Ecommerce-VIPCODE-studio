                                ...
                                <tr key={product.id}>
                                    ...
                                    <td rowSpan={product.stock.length}>
                                        <div className={styles.products__table__action}>
                                            <Button type="button" className={styles.products__table__action__edit} ><i className='bx bxs-edit' /></Button>
                                            <Button type="button" className={styles.products__table__action__delete} ><i className='bx bxs-trash' /></Button>
                                        </div>
                                    </td>
                                </tr>
